...
namespace ActiviGoApi.Infrastructur.Data
{
        ...
        public static class SeedData
        {
            ...
            {
                new Location { Id = 1, Name = "Central Park", Description = "Large public park with open fields", Adress = "1 Central Park Way", Latitude = "40.785091", Longitude = "-73.968285", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 2, Name = "Riverside Grounds", Description = "Riverside recreational area", Adress = "2 Riverside Ave", Latitude = "40.800000", Longitude = "-73.970000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 3, Name = "Harbor View", Description = "Coastal facility with views of the harbor", Adress = "3 Harbor Rd", Latitude = "40.700000", Longitude = "-74.010000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 4, Name = "North End Complex", Description = "Community sports complex", Adress = "4 North End Ln", Latitude = "40.820000", Longitude = "-73.950000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 5, Name = "South Gate Park", Description = "Southern parkland with trails", Adress = "5 South Gate Blvd", Latitude = "40.760000", Longitude = "-73.980000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 6, Name = "East Point Center", Description = "East-side activity center", Adress = "6 East Point St", Latitude = "40.770000", Longitude = "-73.930000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 7, Name = "West Field Grounds", Description = "Outdoor fields and courts", Adress = "7 West Field Dr", Latitude = "40.740000", Longitude = "-73.990000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 8, Name = "City Center Arena", Description = "Indoor arena in city center", Adress = "8 City Center Pl", Latitude = "40.712776", Longitude = "-74.005974", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 9, Name = "Lakeside Venue", Description = "Venue by the lake", Adress = "9 Lakeside Rd", Latitude = "40.750000", Longitude = "-74.000000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 10, Name = "Old Town Hall", Description = "Converted town hall used for activities", Adress = "10 Old Town Sq", Latitude = "40.730610", Longitude = "-73.935242", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 11, Name = "Green Meadow", Description = "Meadow with event lawns", Adress = "11 Meadow Ln", Latitude = "40.760500", Longitude = "-73.982000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 12, Name = "Highlands Sports", Description = "Highland area with courts and gym", Adress = "12 Highlands Ave", Latitude = "40.780000", Longitude = "-73.960000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 13, Name = "Sunset Plaza", Description = "Plaza suitable for classes and markets", Adress = "13 Sunset Blvd", Latitude = "40.710000", Longitude = "-74.015000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 14, Name = "Mountain Base", Description = "Base facility near small hills", Adress = "14 Mountain Rd", Latitude = "40.850000", Longitude = "-73.880000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 15, Name = "Valley Hub", Description = "Community hub in the valley", Adress = "15 Valley St", Latitude = "40.690000", Longitude = "-74.020000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 16, Name = "Seafront Deck", Description = "Seafront with promenade", Adress = "16 Seafront Ave", Latitude = "40.700500", Longitude = "-74.012000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 17, Name = "Meadow Park", Description = "Small park with playground", Adress = "17 Meadow Park Ln", Latitude = "40.755000", Longitude = "-73.987000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 18, Name = "Station Square", Description = "Square adjacent to main station", Adress = "18 Station Sq", Latitude = "40.752726", Longitude = "-73.977229", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 19, Name = "Festival Grounds", Description = "Large open area used for events", Adress = "19 Festival Grounds", Latitude = "40.748000", Longitude = "-73.985500", IsActive = true, CreatedAt = D1, UpdatedAt = D2 },
                new Location { Id = 20, Name = "Civic Plaza", Description = "Plaza in front of civic buildings", Adress = "20 Civic Plaza", Latitude = "40.741000", Longitude = "-73.989000", IsActive = true, CreatedAt = D1, UpdatedAt = D2 }
            };
            }
